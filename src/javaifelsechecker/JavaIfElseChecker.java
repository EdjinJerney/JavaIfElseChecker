...
public class JavaIfElseChecker
{
    ...
    {
        String regex1 = "if\\(.*";
        String regex2 = "if(\\((?:((?:[a-zA-Z_]\\w*|[0-9])(?:[<>]=?|==|!=)(?:[a-zA-Z_]\\w*|[0-9]*(?:\\.[0-9]+)?))|((?:[a-zA-Z_]\\w*)\\.(?:contains|equals)\\((?:[A-Za-z0-9]+|[\\\"']\\w*[\\\"'])\\))|((?:[a-zA-Z_]\\w*)\\.isEmpty\\(\\)))(?:(&&|\\|\\|)(?:((?:[a-zA-Z_]\\w*|[0-9])(?:[<>]=?|==|!=)(?:[a-zA-Z_]\\w*|[0-9]*(?:\\.[0-9]+)?))|((?:[a-zA-Z_]\\w*)\\.(?:contains|equals)\\((?:[A-Za-z0-9]+|[\\\"']\\w*[\\\"'])\\))|((?:[a-zA-Z_]\\w*+)\\.isEmpty\\(\\))))*).*";
        String regex3 = "if(\\((?:((?:[a-zA-Z_]\\w*|[0-9])(?:[<>]=?|==|!=)(?:[a-zA-Z_]\\w*|[0-9]*(?:\\.[0-9]+)?))|((?:[a-zA-Z_]\\w*)\\.(?:contains|equals)\\((?:[A-Za-z0-9]+|[\\\"']\\w*[\\\"'])\\))|((?:[a-zA-Z_]\\w*)\\.isEmpty\\(\\)))(?:(&&|\\|\\|)(?:((?:[a-zA-Z_]\\w*|[0-9])(?:[<>]=?|==|!=)(?:[a-zA-Z_]\\w*|[0-9]*(?:\\.[0-9]+)?))|((?:[a-zA-Z_]\\w*)\\.(?:contains|equals)\\((?:[A-Za-z0-9]+|[\\\"']\\w*[\\\"'])\\))|((?:[a-zA-Z_]\\w*+)\\.isEmpty\\(\\))))*\\)).*";
    ...
    {     
        String regex1 = ".*else\\{.*";
        String regex2 = "if(\\((?:((?:[a-zA-Z_]\\w*|[0-9])(?:[<>]=?|==|!=)(?:[a-zA-Z_]\\w*|[0-9]*(?:\\.[0-9]+)?))|((?:[a-zA-Z_]\\w*)\\.(?:contains|equals)\\((?:[A-Za-z0-9]+|[\\\"']\\w*[\\\"'])\\))|((?:[a-zA-Z_]\\w*)\\.isEmpty\\(\\)))(?:(&&|\\|\\|)(?:((?:[a-zA-Z_]\\w*|[0-9])(?:[<>]=?|==|!=)(?:[a-zA-Z_]\\w*|[0-9]*(?:\\.[0-9]+)?))|((?:[a-zA-Z_]\\w*)\\.(?:contains|equals)\\((?:[A-Za-z0-9]+|[\\\"']\\w*[\\\"'])\\))|((?:[a-zA-Z_]\\w*+)\\.isEmpty\\(\\))))*\\))\\{(?:(?:(?:System.out.print(?:ln)?\\((?:(?:[a-zA-Z_]\\w*|[\\\"']\\w*[\\\"']))\\)\\;)|(?:[A-Za-z_]\\w*(?:\\+\\+|\\-\\-))\\;|(?:[a-zA-Z_]\\w*\\=(?:[a-zA-Z_]\\w*|[1-9][0-9]*(\\.[0-9]+)?|\\\"(\\w| )*\\\"))\\;)*|(?:[a-zA-Z_]\\w*\\=([a-zA-Z_]\\w*|[1-9][0-9]*(\\.[0-9]+)?)((\\+|\\-|\\*|\\/)([a-zA-Z_]\\w*|[1-9][0-9]*(\\.[0-9]+)?))*)\\;)\\}(else\\{(?:(?:(?:System.out.print(?:ln)?\\((?:(?:[a-zA-Z_]\\w*|[\\\"']\\w*[\\\"']))\\)\\;)|(?:[A-Za-z_]\\w*(?:\\+\\+|\\-\\-))\\;|(?:[a-zA-Z_]\\w*\\=(?:[a-zA-Z_]\\w*|[1-9][0-9]*(\\.[0-9]+)?|\\\"(\\w| )*\\\"))\\;)*|(?:[a-zA-Z_]\\w*\\=([a-zA-Z_]\\w*|[1-9][0-9]*(\\.[0-9]+)?)((\\+|\\-|\\*|\\/)([a-zA-Z_]\\w*|[1-9][0-9]*(\\.[0-9]+)?))*)\\;))?";
        String regex3 = "if(\\((?:((?:[a-zA-Z_]\\w*|[0-9])(?:[<>]=?|==|!=)(?:[a-zA-Z_]\\w*|[0-9]*(?:\\.[0-9]+)?))|((?:[a-zA-Z_]\\w*)\\.(?:contains|equals)\\((?:[A-Za-z0-9]+|[\\\"']\\w*[\\\"'])\\))|((?:[a-zA-Z_]\\w*)\\.isEmpty\\(\\)))(?:(&&|\\|\\|)(?:((?:[a-zA-Z_]\\w*|[0-9])(?:[<>]=?|==|!=)(?:[a-zA-Z_]\\w*|[0-9]*(?:\\.[0-9]+)?))|((?:[a-zA-Z_]\\w*)\\.(?:contains|equals)\\((?:[A-Za-z0-9]+|[\\\"']\\w*[\\\"'])\\))|((?:[a-zA-Z_]\\w*+)\\.isEmpty\\(\\))))*\\))\\{(?:(?:(?:System.out.print(?:ln)?\\((?:(?:[a-zA-Z_]\\w*|[\\\"']\\w*[\\\"']))\\)\\;)|(?:[A-Za-z_]\\w*(?:\\+\\+|\\-\\-))\\;|(?:[a-zA-Z_]\\w*\\=(?:[a-zA-Z_]\\w*|[1-9][0-9]*(\\.[0-9]+)?|\\\"(\\w| )*\\\"))\\;)*|(?:[a-zA-Z_]\\w*\\=([a-zA-Z_]\\w*|[1-9][0-9]*(\\.[0-9]+)?)((\\+|\\-|\\*|\\/)([a-zA-Z_]\\w*|[1-9][0-9]*(\\.[0-9]+)?))*)\\;)\\}(else\\{(?:(?:(?:System.out.print(?:ln)?\\((?:(?:[a-zA-Z_]\\w*|[\\\"']\\w*[\\\"']))\\)\\;)|(?:[A-Za-z_]\\w*(?:\\+\\+|\\-\\-))\\;|(?:[a-zA-Z_]\\w*\\=(?:[a-zA-Z_]\\w*|[1-9][0-9]*(\\.[0-9]+)?|\\\"(\\w| )*\\\"))\\;)*|(?:[a-zA-Z_]\\w*\\=([a-zA-Z_]\\w*|[1-9][0-9]*(\\.[0-9]+)?)((\\+|\\-|\\*|\\/)([a-zA-Z_]\\w*|[1-9][0-9]*(\\.[0-9]+)?))*)\\;)\\})?";
